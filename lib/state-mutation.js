...
var updateOrInsertResourcesIntoState = exports.updateOrInsertResourcesIntoState = function updateOrInsertResourcesIntoState(state, resources) {
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { clearTypes: [] };

  var newState = state;

  options.clearTypes.forEach(function (type) {
    newState = _objectPathImmutable2.default.del(newState, type);
  });
